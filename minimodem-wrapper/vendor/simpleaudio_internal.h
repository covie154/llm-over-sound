...
/*
 * minimodem-wrapper: WinMM backend, selected via SA_BACKEND_WINAUDIO
 * (see simpleaudio.h enum) and dispatched in simpleaudio.c under USE_WINAUDIO.
 * Implemented in simpleaudio-winmm.c.
 */
#ifdef USE_WINAUDIO
extern const struct simpleaudio_backend simpleaudio_backend_winaudio;
#endif
